...
input_filename = '/calculate/iwtm41_lokal/Windows-RemotePC-SharedFolder/9_prestrained_768e-3'
hisv_in = 47
hisv_out = hisv_in

input_file = input_filename + '.inc'
output_file = input_filename+'_M1.inc'
  ...
  with open(input_file, 'r') as input_f: # read only
    ...
    for line_content in input_f:
      ...
      if ( buffer_process ):        
          ...
          defoGrad_list = np.genfromtxt(line_buffer[10:], delimiter=[16]*5)
